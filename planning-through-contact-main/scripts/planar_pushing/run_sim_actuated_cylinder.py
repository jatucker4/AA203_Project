...
def run_sim(
    ...
    # environment.export_diagram("environment_diagram_cylinder.pdf")
...
if __name__ == "__main__":
    ...
    run_sim(
        ...
        plan="/home/john/tpush/hardware_demos/hw_demos_20240602000108_tee/hw_demo_2/trajectory/traj_rounded.pkl", # 0.5
        # plan = "/home/john/tpush/hardware_demos/hw_demos_20240603153157_tee/hw_demo_2/trajectory/traj_rounded.pkl", # 0.8
        save_recording=True,
        debug=True,
        station_meshcat=station_meshcat,
        state_estimator_meshcat=state_estimator_meshcat,
